...
from prosperity_lib.models.test_options import TestOptions, TradeMatchingMode
sys.path.insert(0, os.path.abspath("prosperity_lib"))
...
def run(
    ...
    options.back_data_dir = str(data) if data is not None else "data"
