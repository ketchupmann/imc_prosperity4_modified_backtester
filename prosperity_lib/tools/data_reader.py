...
from prosperity_lib.datamodel import Trade, Symbol
from prosperity_lib.models.input import PriceRow, ObservationRow, BacktestData
...
class FileSystemReader(BackDataReader):
    ...
    @contextmanager
    def _read_file_content(self, path_parts: list[str]) -> ContextManager[Optional[Path]]:
        # path_parts looks like ['round0', 'prices_round_0_day_-1.csv']
        file_path = self.data_root.joinpath(*path_parts)
